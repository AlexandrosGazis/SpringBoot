...
INSERT INTO `owneruser` VALUES (0,'testdata','testdata','testdata','testdata','testdata','testdata','BMW','test','test'),(1,'fgfasd99','asd','ljkjlkk','t','das','addasdas','Pegeuot','sad','Administrator'),(2,'SDE-234','Katerina','Laskari//','Aigalew','katerina@ee.duth.gr','qwerty1','BMW','AIEK-2345','User'),(3,'ERq-234','Giwrtos','Papadopoylos/','Kesariani','giwrgaras@yahoo.gr','qwerty2','Toyota','SFE-3452','User'),(4,'BHU-678','Kwstas','Balanikas','Agio','kwstakis@ee.aueb.rb','qwerty3','Pegeuot','ERT-2345','User'),(5,'ASE-2334','xRISTOS','GIanνακοπουλος','Περιστερη','giannakos@aol.com','qwerty5','Toytota','HMY-4467','Administrator'),(7,'ASE-2934','Akisx','Papakis','Περιστερη','akis@aol.com','qwerty2009','Renaut','HMY-4997','User'),(8,'ASE-2934','xRISTaras','Τζανακοπουλος','Κηφισια','xristaakos@aol.com','awehgd2@!4dD','Toytota','HMY-4497','User');
...
INSERT INTO `repair` VALUES (1,'2019-01-22','καλη','Μικρη',22.5,'Αλεξανδρος','πισω δεξια φαναρι',NULL),(2,'2018-01-22','πολυ καλη','Μεγάλη',12.5,'Ιασωνας','προβλημα στα λαστιχα',NULL),(5,'2018-01-22','πολυ καλη','Μικρη',12.5,'Ιασωνας','προβλημα στα λαστιχα',NULL);
...
-- Dump completed on 2018-12-16 11:46:06
