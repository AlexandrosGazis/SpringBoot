...
INSERT INTO `owneruser` VALUES (1,'fgfasd','asd','ljkjlkkl','asd','das','addasdas','sad','sad','Administrator'),(2,'SDE-234','Katerina','Laskari','Aigalew','katerina@ee.duth.gr','qwerty1','BMW','AIEK-2345','User'),(3,'ERq-234','Giwrtos','Papadopoylos','Kesariani','giwrgaras@yahoo.gr','qwerty2','Toyota','SFE-3452','User'),(4,'BHU-678','Kwstas','Balanikas','Agio Stefano','kwstakis@ee.aueb.rb','qwerty3','Pegeuot','ERT-2345','User'),(5,'ASE-2334','xRISTOS','GIanνακοπουλος','Περιστερη','giannakos@aol.com','qwerty5','Toytota','HMY-4467','Administrator'),(7,'ASE-2934','Akis ','Papakis','Περιστερη','akis@aol.com','qwerty2009','Renaut','HMY-4997','User'),(8,'ASE-2934','xRISTaras','Τζανακοπουλος','Κηφισια','xristaakos@aol.com','awehgd2@!4dD','Toytota','HMY-4497','User'),(9,'gdfgdgfdgdg','dg','dgdfgfd','dfgdfg','fdgdfg','dfgdfg','dfgdf','gdfgdfgf','Administrator'),(67,'bffgvsdvbgfdhgdhgdh','ghgdghdhgd','hg','dhg','dhg','dhg','dh','gdhhdgdghhgd','User'),(68,'bffgvsdvbgfdhgdhgdh','ghgdghdhgd','hg','dhg','dhg','dhg','dh','gdhhdgdghhgd','User');
...
INSERT INTO `repair` VALUES (1,'2019-01-22','καλη','Μικρη',22.5,'Αλεξανδρος','πισω δεξια φαναρι'),(2,'2018-01-22','πολυ καληkkjjkkkhkjh','Μεγάλη',12.5,'Ιασωνας','προβλημα στα λαστιχα'),(3,'2014-01-22','μετρια','Μικρη',150.4,'Γιαννης','θελει λαδια+service η μηχανη'),(5,'2018-01-22','πολυ καλη','Μικρη',12.5,'Ιασωνας','προβλημα στα λαστιχα');
...
-- Dump completed on 2018-12-11 19:08:03
