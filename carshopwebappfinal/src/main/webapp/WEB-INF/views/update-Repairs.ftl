...
<div class="container">
    <div class="col-lg-12">
        <center> <h2 class="my-4">Edit an existing repair</h2> </center>
    </div>
    <center><form action ="updateRepair" method="post" class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="textinput" name="id" type="text" value="${repair.id}" readonly="true" placeholder="Enter a valid id" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="textinput" name="date" value="${repair.date}" val type="text" placeholder="Enter a date" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="textinput" name="katastasi" value="${repair.katastasi}" type="text" placeholder="Enter the vehicle's current state" class="form-control input-md">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Status</label>
                    <div class="col-md-4">
                        <input id="textinput" name="eidosepiskeuis" value="${repair.eidosepiskeuis}" type="text" placeholder="Enter the vehicle's current state" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="lastname" name="kostos" value="${repair.kostos}" type="text" placeholder="Enter the cost (dot separated)" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="email" name="owner" value="${repair.owner}" type="text" placeholder="Enter the owner's name" class="form-control input-md">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="brand" name="perigrafi" value="${repair.perigrafi}" type="text" placeholder="Enter the details of the repair" class="form-control input-md">
